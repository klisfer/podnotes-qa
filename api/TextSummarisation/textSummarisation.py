...
def refineSummary(text):
    prompt = "this is the raw text that needs to be used to create a blog article in 500-700 words. Add subheaders bullet points to make the article easily digestable. Maintain the context. Give the output in md format. Add line breaks after headers \n \n " + text
